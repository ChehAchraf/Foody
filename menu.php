            ...
            <div class="container">
                ...
                <div class="menu-tab">
                    <ul class="nav nav-pills justify-content-center">
                        ...
                        $is_first_tab = true; // To set the first tab as active
                        ...
                        <?php
                            $is_first_tab = false; // After the first iteration
                        } ?>
                    </ul>
                    ...
                    <div class="tab-content">
                        <?php
                        // Reset the result pointer for fetching menu data again
                        $menus_result->data_seek(0);
                        $is_first_content = true; // To set the first tab content as active
                        while ($menu = $menus_result->fetch_assoc()) {
                            $menu_id = $menu['id'];
